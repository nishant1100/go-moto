...
const carData = [
  ...
  { name: "Mercedes", type: "Sport", price: 3000, transmission: "Manual", ac: true, location: "Pokhara", available: false },
  { name: "Mercedes", type: "Sedan", price: 2700, transmission: "Automat", ac: true, location: "Kathmandu", available: true },
  { name: "Porsche", type: "SUV", price: 3500, transmission: "Automat", ac: true, location: "Pokhara", available: true },
  { name: "Toyota", type: "Sedan", price: 2300, transmission: "Manual", ac: true, location: "Kathmandu", available: false },
...
const RentCars = () => {
  ...
  return (
    <section className="rent-section">
      ...
      <p>Find the perfect car for your needs with our easy-to-use filters.</p>
